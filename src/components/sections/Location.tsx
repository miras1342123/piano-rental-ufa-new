              ...
              <div>
                ...
                <div className="flex gap-3 mt-2">
                  ...
                  <a
                    ...
                    className="px-4 py-2 rounded-full bg-graphite/5 text-graphite/70 transition-all duration-300 ease-premium text-sm font-medium inline-flex items-center gap-1.5 hover:bg-brass hover:text-white"
                  >
